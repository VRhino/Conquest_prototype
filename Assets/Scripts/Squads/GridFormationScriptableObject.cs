...
public class GridFormationScriptableObject : ScriptableObject
{
    ...
    {
        if (gridPositions == null || gridPositions.Length == 0) return System.Array.Empty<Vector3>();
    ...
    /// </summary>
    public Vector3[] GetAbsoluteWorldOffsets() => GetWorldOffsets();
    ...
    {
        if (gridPositions == null || gridPositions.Length == 0) return Vector2.zero;
    ...
    /// </summary>
    public Vector3[] GetCenteredWorldOffsets() => GetWorldOffsets();
}
