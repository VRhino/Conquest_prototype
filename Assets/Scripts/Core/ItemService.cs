...
public static class ItemService
{
    ...
    /// </summary>
    /// <param name="itemCategory">Categoría de ítem a filtrar</param>
    /// <returns>Lista de ítems de la categoría especificada</returns>
    public static List<ItemDataSO> GetItemsByCategory(ItemCategory itemCategory)
    {
        EnsureInitialized();
        
        if (_itemsByCategory.TryGetValue(itemCategory, out List<ItemDataSO> items))
            return new List<ItemDataSO>(items);
    ...
    /// <summary>
    /// Obtiene todos los ítems de un tipo de armadura específico.
    /// </summary>
    /// <param name="armorType">Tipo de armadura a filtrar</param>
    /// <returns>Lista de ítems del tipo de armadura especificado</returns>
    public static List<ItemDataSO> GetItemsByArmorType(ArmorType armorType)
    {
        EnsureInitialized();
        
        if (_itemsByArmorType.TryGetValue(armorType, out List<ItemDataSO> items))
            return new List<ItemDataSO>(items);
    ...
    /// <summary>
    /// Obtiene todos los ítems de una rareza específica.
    /// </summary>
    /// <param name="rarity">Rareza a filtrar</param>
    /// <returns>Lista de ítems de la rareza especificada</returns>
    public static List<ItemDataSO> GetItemsByRarity(ItemRarity rarity)
    {
        EnsureInitialized();
        
        if (_itemsByRarity.TryGetValue(rarity, out List<ItemDataSO> items))
            return new List<ItemDataSO>(items);
    ...
    /// </summary>
    /// <returns>Lista completa de todos los ítems</returns>
    public static List<ItemDataSO> GetAllItems()
    {
        EnsureInitialized();
        return new List<ItemDataSO>(_itemCache.Values);
    }
